...
#     # Insert request
#     insertRequest!(scenario.requests[1],vehicleSchedule,1,1,1,2,scenario,[10,10,10,10],[12,12,12,12])
...
#@testset "Check feasibility of insertion: W - ROUTE - P - D - W" begin 
    ...
    feasible, newStartOfServiceTimes, newEndOfServiceTimes,_,_,_= checkFeasibilityOfInsertionAtPosition(request1,vehicleSchedule,3,3,scenario)
    @test feasible == true
    ...
    # Insert request 
    insertRequest!(request1,vehicleSchedule,3,3,1,4,scenario,newStartOfServiceTimes,newEndOfServiceTimes)
    feasible, msg = checkRouteFeasibility(scenario,vehicleSchedule)
    @test feasible == true
    @test msg == ""
#end
...
#     feasible, newStartOfServiceTimes, newEndOfServiceTimes,_,_,_ = checkFeasibilityOfInsertionAtPosition(request2,vehicleSchedule,1,1,scenario)
#     @test feasible == true
...
#     # Insert request
#     insertRequest!(request2,vehicleSchedule,1,1,1,4,scenario,newStartOfServiceTimes,newEndOfServiceTimes)
#     feasible, msg = checkRouteFeasibility(scenario,vehicleSchedule)
#     @test feasible == true
#     @test msg == ""
# end
...
#     feasible, newStartOfServiceTimes, newEndOfServiceTimes,_,_,_ = checkFeasibilityOfInsertionAtPosition(request2,vehicleSchedule,1,2,scenario)
#     @test feasible == false 
...
#     # Insert request
#     insertRequest!(request2,vehicleSchedule,1,2,1,4,scenario,newStartOfServiceTimes,newEndOfServiceTimes)
#     feasible, msg = checkRouteFeasibility(scenario,vehicleSchedule)
#     @test feasible == true
#     @test msg == ""
# end
...
#     feasible, newStartOfServiceTimes, newEndOfServiceTimes,_,_,_ = checkFeasibilityOfInsertionAtPosition(request1,vehicleSchedule,2,3,scenario)
#     @test feasible == true 

#     # Insert request
#     insertRequest!(request1,vehicleSchedule,2,3,1,4,scenario,newStartOfServiceTimes,newEndOfServiceTimes)
#     feasible, msg = checkRouteFeasibility(scenario,vehicleSchedule)
#     @test feasible == true
#     @test msg == ""
# end
...
#    feasible, newStartOfServiceTimes, newEndOfServiceTimes,_,_,_ = checkFeasibilityOfInsertionAtPosition(request2,vehicleSchedule,1,3,scenario)
#    @test feasible == true 

#     # Insert request
#    copyVehicleSchedule = deepcopy(vehicleSchedule)
#    insertRequest!(request2,copyVehicleSchedule,1,3,1,4,scenario,newStartOfServiceTimes,newEndOfServiceTimes)
...
#     # Insert request
#     copyVehicleSchedule = deepcopy(vehicleSchedule)
#     insertRequest!(request2,copyVehicleSchedule,1,2,1,4,scenario,newStartOfServiceTimes,newEndOfServiceTimes)
#     feasible, msg = checkRouteFeasibility(scenario,copyVehicleSchedule)
#     @test feasible == true
#     @test msg == ""
...
#     feasible, newStartOfServiceTimes, newEndOfServiceTimes,_,_,_ = checkFeasibilityOfInsertionAtPosition(request3,vehicleSchedule,3,5,scenario)
#     @test feasible == true
#     @test msg == ""

#      # Insert request
#     copyVehicleSchedule = deepcopy(vehicleSchedule)
#     insertRequest!(request3,copyVehicleSchedule,3,5,1,6,scenario,newStartOfServiceTimes,newEndOfServiceTimes)
#     feasible, msg = checkRouteFeasibility(scenario,copyVehicleSchedule)
#     @test feasible == true
#     @test msg == ""
# end
...
#     feasible, newStartOfServiceTimes, newEndOfServiceTimes,_,_,_ = checkFeasibilityOfInsertionAtPosition(request3,vehicleSchedule,3,3,scenario)
#     @test feasible == true

#     # Insert request
#     copyVehicleSchedule = deepcopy(vehicleSchedule)
#     insertRequest!(request3,copyVehicleSchedule,3,3,1,6,scenario,newStartOfServiceTimes,newEndOfServiceTimes)
#     feasible, msg = checkRouteFeasibility(scenario,copyVehicleSchedule)
#     @test feasible == true
#     @test msg == ""
# end
