...
@testset "Check feasibility of insertion: W - ROUTE - P - D - W" begin 
    ...
    feasible, newStartOfServiceTimes, newEndOfServiceTimes,_,_ = checkFeasibilityOfInsertionAtPosition(request1,vehicleSchedule,3,3,scenario)
    @test feasible == true
...
@testset "Check feasibility of insertion: W - P - D - ROUTE - W" begin 
    ...
    feasible, newStartOfServiceTimes, newEndOfServiceTimes,_,_ = checkFeasibilityOfInsertionAtPosition(request2,vehicleSchedule,1,1,scenario)
    @test feasible == true
...
@testset "Check feasibility of insertion: W - P - ROUTE- D - ROUTE - W" begin 
    ...
    feasible, newStartOfServiceTimes, newEndOfServiceTimes,_,_ = checkFeasibilityOfInsertionAtPosition(request2,vehicleSchedule,1,2,scenario)
    @test feasible == false 
...
@testset "Check feasibility of insertion: W - ROUTE - P - ROUTE- D - ROUTE - W" begin 
    ...
    feasible, newStartOfServiceTimes, newEndOfServiceTimes,_,_ = checkFeasibilityOfInsertionAtPosition(request1,vehicleSchedule,2,3,scenario)
    @test feasible == true 
...
@testset "Check feasibility of insertion: W  - P - ROUTE- D - ROUTE - W" begin 
   ...
   feasible, newStartOfServiceTimes, newEndOfServiceTimes,_,_ = checkFeasibilityOfInsertionAtPosition(request2,vehicleSchedule,1,3,scenario)
   @test feasible == true 
...
@testset "Check feasibility of insertion: W - ROUTE - P - ROUTE- D  - W" begin 
    ...
    feasible, newStartOfServiceTimes, newEndOfServiceTimes,_,_ = checkFeasibilityOfInsertionAtPosition(request3,vehicleSchedule,3,5,scenario)
    @test feasible == true
    @test msg == ""
...
@testset "Check feasibility of insertion: W - ROUTE - P - D - ROUTE - W" begin 
    ...
    feasible, newStartOfServiceTimes, newEndOfServiceTimes,_,_ = checkFeasibilityOfInsertionAtPosition(request3,vehicleSchedule,3,3,scenario)
    @test feasible == true
