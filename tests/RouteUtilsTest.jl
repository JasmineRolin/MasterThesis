...
request1.dropOffActivity.timeWindow = findTimeWindowOfRequestedDropOffTime(410)
...
request1.pickUpActivity.timeWindow = findTimeWindowOfPickUp(request1.dropOffActivity.timeWindow, scenario.time[2,7], request1.maximumRideTime)
...
@testset "Case5: routeFeasibility test - feasbile route" begin 
    ...
    # Requests  
    request1 = scenario.requests[1]
    request1.pickUpActivity.timeWindow.startTime = 405
    request1.pickUpActivity.timeWindow.endTime = 500
    request2 = scenario.requests[4]
