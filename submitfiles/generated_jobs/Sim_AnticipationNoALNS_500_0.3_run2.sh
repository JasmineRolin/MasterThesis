#!/bin/sh
#BSUB -J "Sim_AnticipationNoALNS_500_0.3_run2"
...
for seed in {1..10}; do
  julia --project=. resultExploration/resultsAnticipationNoALNS.jl "500" "0.3" "0.5" "2025-05-15_long" "run2" "AnticipationNoALNS_0.3" "$seed" &
done
