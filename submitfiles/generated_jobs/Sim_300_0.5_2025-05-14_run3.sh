#!/bin/sh
#BSUB -J "Sim_300_0.5_2025-05-14_run3"
...
for seed in {1..10}; do
  julia --project=. resultExploration/resultsAnticipationNoALNS.jl "300" "0.7" "0.5" "2025-05-14_run3" "AnticipationNoALNS_0.5" "$seed" &
done
