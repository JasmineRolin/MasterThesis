#!/bin/sh
#BSUB -J "Sim_AnticipationNoALNS_500_0.5_run5"
...
for seed in {1..10}; do
  julia --project=. resultExploration/resultsAnticipationNoALNS.jl "500" "0.5" "0.5" "2025-05-15_long" "run5" "AnticipationNoALNS_0.5" "$seed" &
done
