#!/bin/sh
#BSUB -J "Sim_AnticipationNoALNS_20_0.5_run2"
...
for seed in {1..10}; do
  julia --project=. resultExploration/resultsAnticipationNoALNS.jl "20" "0.5" "0.5" "2025-05-15_v2" "run2" "AnticipationNoALNS_0.5" "$seed" &
done
