#!/bin/sh
#BSUB -J "Sim_AnticipationNoALNS_300_0.5_run3"
...
for seed in {1..10}; do
  julia --project=. resultExploration/resultsAnticipationNoALNS.jl "300" "0.5" "0.5" "2025-05-15_long" "run3" "AnticipationNoALNS_0.5" "$seed" &
done
