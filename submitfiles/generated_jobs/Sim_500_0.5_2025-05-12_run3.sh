#!/bin/sh
#BSUB -J "Sim_500_0.5_2025-05-12_run3"
...
for seed in {1..10}; do
  julia --project=. resultExploration/resultsAnticipationNoALNS.jl "500" "0.7" "0.5" "2025-05-12_run3" "AnticipationNoALNS_0.5" "$seed" &
done
