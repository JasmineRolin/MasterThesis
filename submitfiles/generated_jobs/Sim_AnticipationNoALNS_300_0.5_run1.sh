#!/bin/sh
#BSUB -J "Sim_AnticipationNoALNS_300_0.5_run1"
...
for seed in {1..10}; do
  julia --project=. resultExploration/resultsAnticipationNoALNS.jl "300" "0.5" "0.5" "2025-05-15_long" "run1" "AnticipationNoALNS_0.5" "$seed" &
done
