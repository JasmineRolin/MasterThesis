#!/bin/sh
#BSUB -J "Sim_AnticipationNoALNS_300_0.3_run5"
...
for seed in {1..10}; do
  julia --project=. resultExploration/resultsAnticipationNoALNS.jl "300" "0.3" "0.5" "2025-05-15_long" "run5" "AnticipationNoALNS_0.3" "$seed" &
done
