#!/bin/sh
#BSUB -J "Sim_500_0.9_2025-05-14_run1"
...
for seed in {1..10}; do
  julia --project=. resultExploration/resultsAnticipationNoALNS.jl "500" "0.7" "0.9" "2025-05-14_run1" "AnticipationNoALNS_0.9" "$seed" &
done
