#!/bin/sh
#BSUB -J "Sim_AnticipationNoALNS_500_0.9_run4"
...
for seed in {1..10}; do
  julia --project=. resultExploration/resultsAnticipationNoALNS.jl "500" "0.9" "0.7" "2025-05-15" "run4" "AnticipationNoALNS_0.9" "$seed" &
done
