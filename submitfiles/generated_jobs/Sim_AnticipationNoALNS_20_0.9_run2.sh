#!/bin/sh
#BSUB -J "Sim_AnticipationNoALNS_20_0.9_run2"
...
for seed in {1..10}; do
  julia --project=. resultExploration/resultsAnticipationNoALNS.jl "20" "0.9" "0.7" "2025-05-15" "run2" "AnticipationNoALNS_0.9" "$seed" &
done
