#!/bin/sh
#BSUB -J "Sim_300_0.9_2025-05-12_run2"
...
for seed in {1..10}; do
  julia --project=. resultExploration/resultsAnticipationNoALNS.jl "300" "0.7" "0.9" "2025-05-12_run2" "AnticipationNoALNS_0.9" "$seed" &
done
