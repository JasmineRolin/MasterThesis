#!/bin/sh
#BSUB -J "Sim_100_0.5_2025-05-14_run4"
...
for seed in {1..10}; do
  julia --project=. resultExploration/resultsAnticipationNoALNS.jl "100" "0.7" "0.5" "2025-05-14_run4" "AnticipationNoALNS_0.5" "$seed" &
done
