#!/bin/sh
#BSUB -J "Sim_AnticipationNoALNS_300_0.9_run3"
...
for seed in {1..10}; do
  julia --project=. resultExploration/resultsAnticipationNoALNS.jl "300" "0.9" "0.7" "2025-05-15" "run3" "AnticipationNoALNS_0.9" "$seed" &
done
