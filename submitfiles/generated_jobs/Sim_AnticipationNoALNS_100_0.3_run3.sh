#!/bin/sh
#BSUB -J "Sim_AnticipationNoALNS_100_0.3_run3"
...
for seed in {1..10}; do
  julia --project=. resultExploration/resultsAnticipationNoALNS.jl "100" "0.3" "0.5" "2025-05-15_v2" "run3" "AnticipationNoALNS_0.3" "$seed" &
done
